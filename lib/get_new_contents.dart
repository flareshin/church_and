...
class getNewContents extends StatelessWidget {
  final String newContents;

  getNewContents(this.newContents);

  @override
  Widget build(BuildContext context) {
    CollectionReference groups =
        FirebaseFirestore.instance.collection('NewContents');
    print(newContents);
        ...
        body: Container(
            ...
            child: Column(children: <Widget>[
              ...
              FutureBuilder<DocumentSnapshot>(
                future: groups.doc("$newContents").get(),
